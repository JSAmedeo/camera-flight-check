> ⚠️ **STALE — superseded 2026-09-19.** This snapshot predates the colorway
> refinement pass, the centralized radius-token system, and the entire
> Help Config / Settings-password / App Defaults / Skip Reasons admin
> overhaul. Kept only as a historical diff point for what the app looked
> like on 2026-09-03. For current state, see `DESIGN-SNAPSHOT.md`.
